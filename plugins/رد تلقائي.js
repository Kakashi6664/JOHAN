let handler = m => m; 
 ...
 let responses; 
 if (/^لاو بحبك|لاو عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|لاو هنتجوز امتي|لاو انت ليا|لاو بموت فيك$/i.test(m.text)) { 
 responses = [ 
 'شكرا  ',
   'ونا بكرهك',
 'هفكر في الموضوع',  
 ...
 }else if (/^ لاو عامل ايه|عامله ايه|عاملين ايه|كيفكم|عاملين ايه يشبب$/i.test(m.text)) { 
 responses = [ 
 ...
 }else if (/^لاو|لاو عمك|يا لاو/i.test(m.text)) { 
 responses = [ 
 'قلب لاو كدا كدا🖤',  
 'لاو عمك🖤🤺 ',  
 'ي عيون لاو🖤',  
